...
/***/ function(module, exports, __webpack_require__) {
	...
	function addArticleToList(article) {
	  $("ul.item-list").append("<li><a class='article' data-id='" + article.id + "'>" + article.title + ", by " + article.author + " on " + article.publish_date + "</a></li>");
	}

	function renderArticle(article) {
	  $("#content").append("<article class='article'><h2>" + article.title + "</h2><p>by <em>" + article.author + "</em>, on <em>" + article.publish_date + "</em> <label><input type='checkbox' checked> (read already)</label>" + "<p>Category <a>" + article.category.title + "</a></p> <div class='article-body'><p>" + article.content + "</p></div></article>");
	}
